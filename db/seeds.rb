...
Comment.create!(text: "your definition is spot on", user_id: 1, word_id: 2)
Comment.create!(text: "this is offensive in every way", user_id: 1, word_id: 1)
Comment.create!(text: "eat my shorts", user_id: 3, word_id: 3)
